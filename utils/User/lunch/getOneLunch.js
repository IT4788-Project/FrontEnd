import { getOne } from "../../../services/api/lunch";

export const getOneLunch = async (data, token) => {
    /*
    Uasge: lấy 1 lunch cụ thể của 1 ngày
    Params:
        data = {
    ...
    */
    try {
        ...
        console.error(error, "(catch in function getOneLunch)");
